...
const Hero = () => {
  ...
  return (
    <Section className="pt-[12rem] -mt-[5.25]" crosses customPaddings id="hero">
        <div className = "container relative"> 
            <div className='relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]'>
                ...
                <p className = "body-1 max-w-3xl mxx-auto mb-6 text-n-2 lg:mb-8">
            ...
            <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24'>
                <div className='relative z-1 p-0.5 rounded-2xl bg-conic-gradient'>
                    <div className='relative bg-n-8 rounded-[1rem]'>
                        ...
                        <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[699/490] lg:aspect-[1024/490]'>
